...
public class Location5_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor.putInt("location", 22);
        editor.apply();

     switch (game) {
         case 1:   {
             setContentView(R.layout.location5_5);
                    ...
                    answer1.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            try {
                                ...
                                editor.apply();
                                Intent intent = new Intent(Location5_5.this, Location7.class);
    ...
    public void onBackPressed() {
        try {
            Intent intent = new Intent(Location5_5.this, MainActivity.class);
            shouldPlay=true;
            startActivity(intent);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            finish();
