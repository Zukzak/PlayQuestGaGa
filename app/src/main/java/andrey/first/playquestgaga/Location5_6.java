...
public class Location5_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.location5_6);
        ...
        answer1.setOnClickListener(new View.OnClickListener() {
                       ...
                       public void onClick(View view) {
                           ...
                           main.setBackgroundResource(R.drawable.location5_6_2);
                           ...
                           answer1.setOnClickListener(new View.OnClickListener() {
                               @Override
                               public void onClick(View view) {
                                   main.setBackgroundResource(R.drawable.location5_6);
                                   text.setText("А какой вкусный какао\n она готовит!");
                                   answer1.setText("...");
                                   answer1.setOnClickListener(new View.OnClickListener() {
                                       @Override
                                       public void onClick(View view) {
                                           main.setBackgroundResource(R.drawable.location5_6_1);
                                           text.setText("А когда она поправляет\n волосы, я прям умираю...");
                                           answer1.setText("Спасибо... я пойду...");
                                           answer1.setOnClickListener(new View.OnClickListener() {
                                               @Override
                                               public void onClick(View view) {
                                                   editor.putBoolean("sasha", true);
                                                   editor.apply();
                                                   exitFromLocation();
                                               }
                                           });
       ...
       public void exitFromLocation() {
           try {
               Intent intent = new Intent(Location5_6.this, Location5_1.class);
    ...
    public void onBackPressed() {
        try {
            Intent intent = new Intent(Location5_6.this, MainActivity.class);
            shouldPlay=true;
            startActivity(intent);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            finish();
