...
public class Location1_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.location1_3);
    ...
    public void exitFromLocation(Class n) {
        try {
            Intent intent = new Intent(Location1_3.this, n);
    ...
    public void onBackPressed() {
        try {
            Intent intent = new Intent(Location1_3.this, MainActivity.class);
            shouldPlay=true;
            startActivity(intent);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            finish();
