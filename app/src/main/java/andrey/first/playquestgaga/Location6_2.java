...
public class Location6_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor.putInt("location", 21);
        editor.apply();

        setContentView(R.layout.location6_2);
        ...
        Button answer1 = findViewById(R.id.answer1);
            ...
            answer1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                        ...
                        editor.apply();
                    try {
                        Intent intent = new Intent(Location6_2.this, Location6.class);
    ...
    public void onBackPressed() {
        try {
            Intent intent = new Intent(Location6_2.this, MainActivity.class);
            shouldPlay=true;
            startActivity(intent);
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out);
            finish();
